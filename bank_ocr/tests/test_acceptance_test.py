...
def test_machine_accepts_letter_which_has_account_number_with_invalid_characters_and_produces_file():
    letter_has_account_number_with_invalid_checksum = ["m", 0, 0, 0, 0, "st", 0, 0, 0]
    machine_object = Machine(letter_has_account_number_with_invalid_checksum)
    machine_object.accept_letter_and_produce_file()
